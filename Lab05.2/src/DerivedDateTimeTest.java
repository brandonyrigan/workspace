...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate valentinesDay = LocalDate.of(2021, 2, 14);
        System.out.println(valentinesDay.plusWeeks(38));
        // TODO: what is the average birthday of someone conceived on New Year's Eve (after midnight)?
        LocalDate newYearsEve = LocalDate.of(2021, 12, 31);
        System.out.println(newYearsEve.plusWeeks(38));
    }
    ...
    public static void testEarlyRetirement() {
        // TODO
        LocalDate currentAge = LocalDate.of(2022, 7, 8);
        System.out.println(currentAge.plusYears(31));
    }
    ...
    public static void testLaborDay() {
        ...
        LocalDate laborDay = bday.plusMonths(2).with(firstInMonth(DayOfWeek.MONDAY));
    ...
    public static void testElectionDay() {
        ...
        System.out.println(electionDay.with(firstInMonth(DayOfWeek.TUESDAY)));
    }
    ...
    public static void testAnniversary() {
        ...
        LocalDate partyDate = anniversary.plusYears(50);
        if (partyDate.getDayOfWeek() != DayOfWeek.SATURDAY) {
            partyDate = partyDate.with(next(DayOfWeek.SATURDAY));
        }
