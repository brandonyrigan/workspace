...
class DateTimeTest {
    ...
    public static void testCreate() {
        ...
        String formatBday = bday.format(DateTimeFormatter.ofPattern("EEE, d MMM yyyy"));
        System.out.println("My birthday: " + formatBday);
        ...
        String formatMoonLanding = moonLanding.format(DateTimeFormatter.ofPattern("d MMM yyyy h:mm a"));
        System.out.println("Moon landing: " + formatMoonLanding);
    ...
    public static void testParse() {
        ...
        System.out.println(LocalDate.parse("1994-07-08"));
        // OPTIONAL: now create it by parsing text in the form "2/6/2014" (this is Feb 6, not Jun 2).
        LocalDate bday = LocalDate.of(1994, 7, 8);
        String display = bday.format(DateTimeFormatter.ofPattern("M/d/yyyy"));
    ...
    public static void testFormat() {
        ...
        System.out.println(display);
        // TODO: 14-10-1066
        display = hastings.format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));
        System.out.println(display);
